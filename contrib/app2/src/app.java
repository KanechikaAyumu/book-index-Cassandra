...
//    private static String sum = null;
//    private static ArrayList Listsort = new ArrayList();
...
//String temp2 = itr.nextToken() +"/" + String.valueOf(instant);
//                word.set(temp2);
...
// Change   getMutation(Text, int->String)
...
//INFO app: output reducer type: cassandra 
